...
class AuraAPIClient:
    ...
    def create_instance(
        ...
        # Validate for professional/enterprise/business-critical types
            ...
            if vector_optimized and memory < 4:
                raise ValueError(
                    "vector optimized instances must have at least 4GB memory"
                )
        ...
        if graph_analytics_plugin and type not in [
            "professional-db",
            "enterprise-db",
            "business-critical",
        ]:
            raise ValueError(
                "graph analytics plugin is only available for professional, enterprise, and business-critical instances"
            )

        if vector_optimized and type not in [
            "professional-db",
            "enterprise-db",
            "business-critical",
        ]:
            raise ValueError(
                "vector optimized instances are only available for professional, enterprise, and business-critical instances"
            )
    ...
    def update_instance(
        ...
        if (
            memory is not None
            and vector_optimized is not None
            and vector_optimized
            and memory < 4
        ):
