...
def test_create_instance_vector_optimized_and_memory_less_than_4_should_raise_error(
    aura_client,
):
    with pytest.raises(ValueError):
        aura_client.create_instance(
            memory=3,
...
def test_update_instance_vector_optimized_and_memory_less_than_4_should_raise_error(
    aura_client,
):
    with pytest.raises(ValueError):
        aura_client.update_instance(
            instance_id="test-instance", memory=3, vector_optimized=True
        )
