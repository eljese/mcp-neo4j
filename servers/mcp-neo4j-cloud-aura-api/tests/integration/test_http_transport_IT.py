...
class TestMiddlewareSecurity:
    ...
    @pytest.mark.asyncio
    @pytest.mark.middleware
    async def test_cors_preflight_malicious_origin_blocked(
        self, middleware_test_server
    ):
    ...
    @pytest.mark.asyncio
    @pytest.mark.middleware
    async def test_cors_actual_request_with_origin_blocked(
        self, middleware_test_server
    ):
    ...
    @pytest.mark.asyncio
    @pytest.mark.middleware
    async def test_dns_rebinding_protection_untrusted_hosts(
        self, middleware_test_server
    ):
    ...
    @pytest.mark.asyncio
    @pytest.mark.middleware
    async def test_cors_restricted_server_allowed_origin(
        self, middleware_test_server_restricted_cors
    ):
    ...
    @pytest.mark.asyncio
    @pytest.mark.middleware
    async def test_cors_restricted_server_disallowed_origin(
        self, middleware_test_server_restricted_cors
    ):
